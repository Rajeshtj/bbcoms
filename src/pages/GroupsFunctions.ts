...
class GroupsFunctions {
    ...
    async SetGroupsDetails(groupType: string, groupMemberType: string) {
        ...
        await selectOption("value", data.qa.orgID.toString(), GroupsPageObjects.selectSchool);
    ...
    async selectPerson() {
        ...
        var SelectStudentAccount = `//a[@onclick="addRole(12,${data.qa.orgID.toString()},'members')"]`;
    ...
    await this.MoveAndClick(`//input[@value='${data.qa.orgID.toString()}']`)
