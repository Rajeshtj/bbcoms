...
class AccountsFunctions  { 
      ...
      async createAccount(staffID:string, password:string,password1:string,firstName:string,lastName:string,id:string){
        ...
        await selectOption('value',id , AccountsPageObjects.SelectSchoolValue);
