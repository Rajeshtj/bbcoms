...
describe('Login to the Application as Support User and Create an Account', () => {
    ...
    it('#SMOKE Create Account-2', async() => {
        await browser.pause(2000)
        await AccountsFunctions.createAccount(AccountTestData.staffID,AccountTestData.password,AccountTestData.password,AccountTestData.firstName,AccountTestData.lastName,data.qa.orgID2.toString());
        await AccountsFunctions.saveCloseAccountwindow();
