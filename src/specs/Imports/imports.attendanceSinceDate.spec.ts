...
describe('Verify able to create attendance since date automated message', () => {
    ...
    it('Verify able to Create a data source and a attendance since date automated message', async () => {
        ...
        let ImportName = `Auto_${ImportsTestData.MessageTypeValue.Attendance[2]}_Message`;
        ...
        ImportsTestData.MessageTypeValue.Attendance[2]);
    ...
    it('Verify able to Run the automated message import', async () => {
        let messageDisplayed = await ImportsCommonFunctions.RunImports(ImportsTestData.MessageTypeValue.Attendance[2], 'Message');
