...
describe('Verify able to create attendance with x days automated message', () => {
    ...
    it('Verify able to Create a data source and a attendance with x days automated message', async () => {
        ...
        let ImportName = `Auto_${ImportsTestData.MessageTypeValue.Attendance[3]}_Message`;
    ...
    it('Verify able to Run the automated message import',async () => {
        let messageDisplayed = await ImportsCommonFunctions.RunImports(ImportsTestData.MessageTypeValue.Attendance[3], 'Message');
